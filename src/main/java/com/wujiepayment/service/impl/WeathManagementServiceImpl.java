...
/** 
 * @author 王凯: 
 * @version 创建时间：2015年6月18日 上午9:57:09 
 * 类说明 投资理财
 */
@Service
public class WeathManagementServiceImpl implements WeathManagementService {

	Logger log = Logger.getLogger(WeathManagementServiceImpl.class);
	private String selectStr = "select id,name,descStr,imageUrl,urlStr,createTime,createUserId, "
			+ " updateTime,updateUserId from wealthManagementInf where 1=1 ";
	private String insertStr = "insert into wealthManagementInf(id,name,descStr,imageUrl,urlStr,createTime,createUserId, "
			+ " updateTime,updateUserId ) values(?,?,?,?,?,?,?,?,?,?) ";
	private String formatStr = "yyyy-MM-dd HH:mm:ss";
	@Autowired
	private JdbcTemplate jdbcTemplate;
	@Override
	public WeathManagementInf getEntity(WeathManagementInf t) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<WeathManagementInf> getList(WeathManagementInf t) {
	...
	@Override
	public Map<String, Object> addEntity(WeathManagementInf t) {
	...
	@Override
	public Map<String, Object> editEntity(WeathManagementInf t) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Map<String, Object> delEntity(WeathManagementInf t) {
		Map<String, Object> resultMap = new HashMap<String, Object>();
